<x-layout>
    ...
    <div class="max-w-md mx-auto mb-8">
        <form method="GET" action="/jobs" class="relative">
            <input type="text" 
                   name="q" 
                   value="{{ request('q') }}"
                   placeholder="Search jobs by title, company, or location..." 
                   class="w-full px-4 py-3 pr-12 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        ...
        @if(request('q'))
            <p class="text-sm text-gray-600 mt-2 text-center">
                ...
                <a href="/jobs" class="text-blue-600 hover:text-blue-800 ml-2">Clear</a>
            </p>
        @endif
    </div>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        @else
            <div class="text-center py-12">
                ...
                @if(request('q'))
                    <a href="/jobs" class="text-blue-600 hover:text-blue-800 font-semibold">View all jobs</a>
                @endif
            </div>
        @endif
    </div>
